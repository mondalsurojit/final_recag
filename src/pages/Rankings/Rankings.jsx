    ...
    return (
        <div>
            ...
            <div className="flex sm:m-8 m-2">
                ...
                <section className={`ranking das`} style={{ overflow: 'scroll', height: "100vh", width: "100vw", backgroundColor: "white", borderRadius: "15px", zIndex: "0", paddingBottom: "3rem", padding:"10px 16px" }}
                >
                    <div className="rank-container">
                        ...
                        <div className="rank-content">
                            ...
                            {/* <!-- BEGIN: Top Bar --> */}
                            <div className="relative z-[51] flex h-[40px] items-center border-b border-slate-200 pb-2" style={{ marginTop: "10px", zIndex: "0" }}>

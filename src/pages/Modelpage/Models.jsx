    ...
    return (
        <div>
            ...
            <div className="flex sm:m-8 m-2">
                ...
                <section className={`model das`} style={{ overflow: 'scroll', width: "100vw", backgroundColor: "#f1f5f9", borderRadius: "15px", padding: "0 2rem" }}
                >
                    ...
                    <div className="trending-section">
                        <div className="top-trending">
                            ...
                            <div className="trending-side-data"><a href='/model/trending-model'>See All</a></div>
                        </div>

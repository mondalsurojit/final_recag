    ...
    return (
        <div>
            ...
            <div className="flex sm:m-8 m-2">
                ...
                <section className={`docs-section das`} style={{ overflow: 'scroll', width: "100vw", backgroundColor: "#f1f5f9", borderRadius: "15px" , padding:"2rem"}}
                >
                    <div className='container'>

                       {/* <!-- BEGIN: Top Bar --> */}
                       <div className="relative z-[51] flex h-[67px] items-center border-b border-slate-200" style={{marginTop:"-63px"}}>
